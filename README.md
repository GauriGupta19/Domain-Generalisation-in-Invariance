...
* ```sample_complexity.ipynb``` - The sample complexity analysis between Vanilla VAE and Rotation-invariant VAE (rVAE). Here, rVAE refers to the RotInvVAE model discussed in the paper
